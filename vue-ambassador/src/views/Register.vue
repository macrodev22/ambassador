<template>
    ...
    <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle bg-body-tertiary">
    ...
    <main class="form-register w-100 m-auto">
        <form>
            ...
            <div class="form-floating">
                <input type="text" class="form-control mid" id="floatingInput" placeholder="name@example.com"
                    v-model="last_name">
